...
public:
  ...
  static AVSValue AvgPlane(int n, AVSValue clip, void* user_data, int plane, int offset, IScriptEnvironment* env);
};

class ComparePlane {

public:
  static AVSValue CmpPlane(int n, AVSValue clip, AVSValue clip2, void* user_data, int plane, IScriptEnvironment* env);
  static AVSValue CmpPlaneSame(int n, AVSValue clip, void* user_data, int offset, int plane, IScriptEnvironment* env);
...
public:
  static AVSValue MinMax(int n, AVSValue clip, void* user_data, double threshold, int offset, int plane, int mode, IScriptEnvironment* env);
